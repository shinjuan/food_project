	...
	<div class="container">
		...
		<div class="tab">
			<ul>
				...
				<li data-tab="3" class='tabmenu' value="chinese" onclick="location.href='food_chinese'">중식</li>
				<li data-tab="4" class='tabmenu' value="japanese" onclick="location.href='food_japanese'" style="background-color: green;">일식</li>
